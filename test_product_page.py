...
import pytest
from constant import PRODUCT_PAGE_URL, MAIN_PAGE_URL
import time
...
def test_guest_can_add_product_to_basket(browser, link):
    ...
    page.should_be_product_adding_to_basket()
...
class TestUserAddToBasketFromProductPage():
    ...
    def setup(self, browser):
        ...
        password = "88888888lol"
        login_page = LoginPage(browser, MAIN_PAGE_URL)
        login_page.open()
